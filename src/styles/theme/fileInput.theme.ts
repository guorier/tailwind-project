import type { FileInputTheme } from '@/components/FileInput/items';

const fileInput: FileInputTheme = {
    root: {
        base: 'flex',
    },
    field: {
        ...
        input: {
            ...
            colors: {
                gray: 'bg-line-50 border-gray-300 text-silver-900 focus:border-cyan-500 focus:ring-cyan-500',
