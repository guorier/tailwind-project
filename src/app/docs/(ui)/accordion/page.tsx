  ...
  return (
    <>
      <div className='mx-auto max-w-7xl'>
        <h3 className='mt-8 mb-4'>아코디언1</h3>
        ...
        <div className="flex flex-col justify-center px-8 py-8 justify-content bg-slate-800 rounded-lg text-white ">
          ...
          <div className="px-4"><span className="text-silver-400">--반복--</span></div>
          <div className="px-4">
            <span className="text-silver-400">&#60;</span>
            <span className="text-pink-500">AccordionPanel</span>
            <span className="text-amber-400  pl-1">collapseAll</span>
            <span className="text-silver-400">&#62;</span>
            <span className="text-silver-400 pl-3">&#47;&#47; // collapseAll 아코디언 패널을 자동으로 축소 설정</span>
          </div>
          <div className="px-8">
            <span className="text-silver-400">&#60;</span>
